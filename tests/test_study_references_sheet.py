...
def test_error(mocker, globals):
  ...
  errors = [
    mocker.call('studyReferences', None, None, "Exception. Error [Failed to detect column(s) 'referenceType, type' in sheet] while reading sheet 'studyReferences'. See log for additional details.", 40),
  ]
