...
def test_create(mocker, globals):
  data = {
    'name': ['A1', 'A2', 'A3'], 
    'description': ['Annotation Text One', 'Annotation Text Two', 'Annotation Text Three'],
    'label': ['LABEL1', 'LABEL2', 'LABEL3'],
    'retained': [True, False, True],
    'includesDNA': [True, False, True],
  }
  mock_id = mocker.patch("usdm_excel.id_manager.IdManager.build_id")
  mock_id.side_effect=['BiospecimenRetention_1', 'BiospecimenRetention_2', 'BiospecimenRetention_3']
