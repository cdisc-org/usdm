...
class MinimalStudy():
  ...
  def __init__(self, globals: Globals):
    ...
    identifier = factory.item(StudyIdentifier, {'studyIdentifier': 'SPONSOR-1234', 'studyIdentifierScope': organization_1})
    ...
    reg_1_identifier = factory.item(StudyIdentifier, {'studyIdentifier': 'REG 111111', 'studyIdentifierScope': organization_2})
    ...
    reg_2_identifier = factory.item(StudyIdentifier, {'studyIdentifier': 'REG 222222', 'studyIdentifierScope': organization_3})
