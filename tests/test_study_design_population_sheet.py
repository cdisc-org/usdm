...
def test_create(mocker, globals):
    ...
    assert item.population.model_dump() == {
        "cohorts": [
            {
                ...
                "plannedAge": {
                    ...
                    "instanceType": "Range",
                    "isApproximate": False,
                    "maxValue": {"id": "X_23", "value": 50.0, "unit":{
                        "id": "X_21",
                    ...
                    "minValue": {"id": "X_22", "value": 50.0, "unit": {
                        "id": "X_21",
                        "instanceType": "AliasCode",
                        "standardCode": {
                            "code": "C29848",
                ...
                "plannedCompletionNumber": {
                    ...
                    "instanceType": "Range",
                    "isApproximate": False,
                    "maxValue": {"id": "X_15", "value": 10.0, "unit": None, "instanceType": "Quantity"},
                    "minValue": {"id": "X_14", "value": 5.0, "unit": None, "instanceType": "Quantity"},
                },
                "plannedEnrollmentNumber": {
                    "id": "X_19",
                    "instanceType": "Range",
                    "isApproximate": False,
                    "maxValue": {"id": "X_18", "value": 50.0, "unit": None, "instanceType": "Quantity"},
                    "minValue": {"id": "X_17", "value": 50.0, "unit": None, "instanceType": "Quantity"},
                },
                "plannedSex": [
                    {
                        "code": "C20197",
            ...
            },
            {
                ...
                "plannedAge": {
                    ...
                    "instanceType": "Range",
                    "isApproximate": False,
                    "maxValue": {"id": "X_36", "value": 60.0, "unit": {
                        "id": "X_34",
                        "instanceType": "AliasCode",
                        "standardCode": {
                            "code": "C29848",
                    ...
                    "minValue": {"id": "X_35", "value": 50.0, "unit": {
                        "id": "X_34",
                        "instanceType": "AliasCode",
                        "standardCode": {
                            "code": "C29848",
                ...
                "plannedCompletionNumber": {
                    ...
                    "instanceType": "Range",
                    "isApproximate": False,
                    "maxValue": {"id": "X_28", "value": 10.0, "unit": None, "instanceType": "Quantity"},
                    "minValue": {"id": "X_27", "value": 5.0, "unit": None, "instanceType": "Quantity"},
                },
                "plannedEnrollmentNumber": {
                    "id": "X_32",
                    "instanceType": "Range",
                    "isApproximate": False,
                    "maxValue": {"id": "X_31", "value": 60.0, "unit": None, "instanceType": "Quantity"},
                    "minValue": {"id": "X_30", "value": 50.0, "unit": None, "instanceType": "Quantity"},
                },
                "plannedSex": [
                    {
                        "code": "C16576",
        ...
        "plannedAge": {
            ...
            "instanceType": "Range",
            "isApproximate": False,
            "maxValue": {"id": "X_10", "value": 110.0, "unit": {
                "id": "X_8",
                "instanceType": "AliasCode",
                "standardCode": {
                    "code": "C29848",
            ...
            "minValue": {"id": "X_9", "value": 100.0,"unit": {
                "id": "X_8",
                "instanceType": "AliasCode",
                "standardCode": {
                    "code": "C29848",
        ...
        "plannedCompletionNumber": {
            ...
            "instanceType": "Range",
            "isApproximate": False,
            "maxValue": {"id": "X_2", "value": 20.0, "unit": None, "instanceType": "Quantity"},
            "minValue": {"id": "X_1", "value": 10.0, "unit": None, "instanceType": "Quantity"},
        },
        "plannedEnrollmentNumber": {
            "id": "X_6",
            "instanceType": "Range",
            "isApproximate": False,
            "maxValue": {"id": "X_5", "value": 110.0, "unit": None, "instanceType": "Quantity"},
            "minValue": {"id": "X_4", "value": 100.0, "unit": None, "instanceType": "Quantity"},
        },
        "plannedSex": [
            {
                "code": "C49636",
