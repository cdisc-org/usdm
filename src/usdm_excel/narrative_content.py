...
class NarrativeContent():
  ...
  #   doc = Doc()
  #   with doc.tag('table'):
  #     m11.title_page_entry(doc, 'Sponsor Confidentiality Statement:', '', 'Enter Sponsor Confidentiality Statement')
  #     m11.title_page_entry(doc, 'Full Title:', f'{self._study_full_title()}', 'Enter Full Title')
  #     m11.title_page_entry(doc, 'Trial Acronym:', f'{self._study_acronym()}', 'Enter trial Acronym')
  #     m11.title_page_entry(doc, 'Protocol Identifier:', f'{self._study_identifier()}', 'Enter Protocol Identifier')
  #     m11.title_page_entry(doc, 'Original Protocol:', '', 'Original protocol')
  #     m11.title_page_entry(doc, 'Version Number:', f'{self._study_version()}', 'Enter Version Number')
  #     m11.title_page_entry(doc, 'Version Date:', f'{self._study_date()}', 'Enter Version Date')
  #     m11.title_page_entry(doc, 'Amendment Identifier:', f'{self._amendment()}', 'Amendment Identifier')
  #     m11.title_page_entry(doc, 'Amendment Scope:', f'{self._amendment_scopes()}', 'Amendment Scope')
  #     m11.title_page_entry(doc, 'Compound Codes(s):', '', 'Enter Compound Code(s)')
  #     m11.title_page_entry(doc, 'Compound Name(s):', '', 'Enter Nonproprietary Name(s), Enter Proprietary Name(s)')
  #     m11.title_page_entry(doc, 'Trial Phase:', f'{self._study_phase()}', 'Trial Phase')
  #     m11.title_page_entry(doc, 'Short Title:', f'{self._study_short_title()}', 'Enter Trial Short Title')
  #     m11.title_page_entry(doc, 'Sponsor Name and Address:', f'{self._organization_name_and_address()}', 'Enter Sponsor Name, Enter Sponsor Legal Address')
  #     m11.title_page_entry(doc, 'Regulatory Agency Identifier Number(s):', f'{self._study_regulatory_identifiers()}', 'EU CT Number, IDE Number, FDA IND Number, JRCT Number, NCT Number, NMPA IND Number, WHO/UTN Number, Other Regulatory Agency Identifier Number')
  #     m11.title_page_entry(doc, 'Spondor Approval Date:', f'{self._approval_date()}', 'Enter Approval Date or state location where information can be found')
  ...
  #       m11.critieria_entry(doc, criterion['identifier'], criterion['text'])
  #   return doc.getvalue()
  ...
  #       m11.objective_endpoints_entry(doc, item['objective'], item['endpoints'])
  #   return doc.getvalue()
